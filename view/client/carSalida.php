...
$resultadoSalida = $carentry->registrarSalidaVehiculo($_POST['entry_id']);
?>
...
<head>
    ...
    <title>Resultado de Salida de Vehículo</title>
</head>
<body class="bg-gray-100">
<div class="container mx-auto flex justify-center items-center h-screen">
    <div class="max-w-md w-full bg-gris-oscurito rounded-lg shadow-lg p-6">
        <h1 class="text-xl font-semibold mb-4">Resultado de Salida de Vehículo</h1>
