...
<main class="mt-12 p-0 bg-black w-full h-full">
  <section class="absolute w-full h-full">
    ...
    <div class="bg-gray-700 container h-full mx-auto px-4">
      <div class="bg-gray-300 flex items-center justify-center h-full">
        <!--El papa del formulario-->
        <div class="bg-white absolute h-full w-full lg:w-4/12 px-4">

          <!--Contenedor del formulario-->
          <div class="flex flex-col min-w-0 w-full mb-6 shadow-lg rounded-lg bg-gray-300 border-0">

            <div class="rounded-t mb-0 px-6 py-6 pb-0"> <!--Es de la parte de arriba del form-->
