...
<body class="bg-gris-clarito antialiased">
  <div id="root">
    ...
    Dashboard
            ...
            <a href="clientes.php" id="parkingLink" class="hover:text-gray-100 text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block">
      Clientes
        </a>
      </li>
...
<li id="carrosContainer" class="items-center rounded-xl pl-4 pr-4 hover:bg-gris-clarito">
            <a href="ganancias.php" id="carrosLink" class="hover:text-gray-100 text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block">
    Ganancias
</a>
            </li>

            <li id="empleadosContainer" class="items-center rounded-xl pl-4 pr-4 hover:bg-gris-clarito">
    <a href="historial.php" id="empleadosLink" class="hover:text-gray-100 text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block">
        Historial
    </a>
</li>
...
<li id="tarjetasContainer" class="items-center rounded-xl pl-4 pr-4 hover:bg-gris-clarito">
    <a href="membresias.php" id="tarjetasLink" class="hover:text-gray-100 text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block">
        Membresías
    </a>
</li>
...
<li id="visitantesContainer" class="items-center rounded-xl pl-4 pr-4 hover:bg-gris-clarito">
    <a href="comentarios.php" id="visitantesLink" class="hover:text-gray-100 text-blueGray-700 hover:text-blueGray-500 text-xs uppercase py-3 font-bold block">
        Comentarios
    </a>
</li>
          </ul>
