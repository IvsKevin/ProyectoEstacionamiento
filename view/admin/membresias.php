...
<nav class="absolute top-0 left-0 w-full z-10 bg-transparent md:flex-row md:flex-nowrap md:justify-start flex items-center p-4">
          <div class="w-full mx-autp items-center flex justify-between md:flex-nowrap flex-wrap md:px-10 px-4">
            <a class="text-white text-3xl uppercase hidden lg:inline-block font-semibold">Membresias</a>
        ...
        <div class="relative md:pt-32 pb-32 pt-12">
            <div class="px-4 md:px-10 mx-auto w-full">
                <div>
                    ...
                    <div class="overflow-x-400">
                        <table class="table bg-gray-600">
                            <thead>
                                <td class="text-white">Licencias</td>
                                <td class="text-white">Licencias Adquiridas</td>
                            </thead>
                            <thead>
                            <tr>

                                <td>Licencia BÃ¡sica</td>
                                <td><?php echo $resultadoLicenciasBasicas; ?></td>
                            </tr>
                            <tr>
                                <td>Licencia Pro</td>
                                <td><?php echo $resultadoLicenciasPR; ?></td>
                            </tr>
                            <tr>
                                <td>Licencia Regular</td>
                                <td><?php echo $resultadoLicenciasRegulares; ?></td>
                            </tr>
                            </thead>
                        </table>
                        <br>
